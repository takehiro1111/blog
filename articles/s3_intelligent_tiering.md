...
- 低頻度アクセス階層から、直接アーカイブアクセス層やディープアーカイブアクセス階層に移行することが可能。（180〜730日）
...
| 階層 | 料金(USD)/月 |
| --- | --- |
| 高頻度アクセス階層（S3 スタンダード相当） | **0.025/GB(最初の50TB)** / **0.024/GB(次の450TB)** / **0.0023/GB(500TB超)** |
| 低頻度アクセス階層（S3 標準 - 低頻度アクセス相当） | **0.0138/GB** |
| アーカイブインスタントアクセス階層() | **0.005/GB** |
| アーカイブアクセス階層() | **0.0045/GB** |
...
| ディープアーカイブアクセス階層（S3 Glacier Deep Archive 相当） | **0.0099/GB** |
