---
title: "k8s超入門: 基本的なコンポーネントの概要まとめ"
emoji: "🎉"
...
公式のチュートリアルをサクッとレベルで対応しながら書いてます。
...
適度にインプットしつつ、次のステップはEKSを公式Moduleを使用せず各構成要素が見えやすい形式で構築してコードをデプロイしようと思います。
最終的には開発中の高機能のTodoアプリをEKSにデプロイしてCI/CDも実装したい。
